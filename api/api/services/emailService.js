...
async function sendEmail(req) {
  ...
  const transporter = nodemailer.createTransport({
    host: 'smtp.gmail.com',
    port: 587, // Αλλαγή από 465 σε 587
    secure: false, // Χρησιμοποιούμε TLS αντί για SSL
    auth: {
      user: process.env.API_EMAIL_USER,
      pass: process.env.API_EMAIL_PASSWORD,
    },
    logger: true,  // Ενεργοποίηση logging
    debug: true,   // Ενεργοποίηση debugging για περισσότερες πληροφορίες
  });
